<?php
    $youtube_email = $_POST['emailLogin']; // Change this to your youtube sign in email.
    $youtube_password = $_POST['pwd']; // Change this to your youtube sign in password.
    // Developer key: Get your key here: http://code.google.com/apis/youtube/dashboard/.
    $key = 'AIzaSyAlbflcsqSg7b3-Nq-Ggo_4PVzo-MC4Y7s'; 
    
    $source = 'VTP'; // A short string that identifies your application for logging purposes.

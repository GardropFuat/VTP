...
<div id='header'>
    <table>
        <tr>
            ...
            <td><input type="button" OnClick="stopVideo()" value="Load" /></td>
        </tr>
    </table>
</div>
...
<div id="playerDiv">
    ...
    <div id="tag" style="border: 2px solid rgb(161, 161, 161); left: 100px; position: relative; width: 100px; top: 150px; height: 100px;z-index:99;">
